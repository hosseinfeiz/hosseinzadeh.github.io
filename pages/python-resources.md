...
bigimg:	# /path/to/img - or multiple entries <- "Path": "Description">
  - "/img/bigimg/woman-programming.jpg" : "Photo by Christina Morillo from Pexels"
category: Resources
tags: [Pytorch]
...
In this section you almost anything you need to become proficient in using Pytorch in Deep learning projects.


## Docs

* [Official Documentation] - This is first place that you need to study to realize what you can do with pytorch[https://pytorch.org/tutorials/].
* [Pytorch Github] - If you need details about a specific function or cmdlets you can find it there. The
